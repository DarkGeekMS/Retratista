...
class Trainer(object):
    ...
    def valid_epoch(self,data):
        ...
        for step, batch in enumerate(data):
            ...
            with torch.no_grad():
                ...
                logits_reg = self.model(input_ids, segment_ids,input_mask)

            self.outputs.append(logits_reg.cpu().detach())
    ...
    def train_epoch(self,data):
        ...
        for step,  batch in enumerate(data):
            ...
            loss = self.criterion(output=logits_reg,target=label_ids)
            ...
            if self.batch_metrics:
                for metric in self.batch_metrics:
                    metric(logits = logits_reg,target = label_ids)
